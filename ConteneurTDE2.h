#ifndef _CONTENEUR_TDE2_
#define _CONTENEUR_TDE2_
 ...
 * @pre capa>0 et p>0
 */
void initialiser(ConteneurTDE2& c, unsigned int capa, unsigned int p);
 ...
 * @pre i < c.capacite   
 */
 Item2 lire(const ConteneurTDE2& c, unsigned int i);
 ...
 */
void ecrire(ConteneurTDE2& c, unsigned int i, const Item2& it);
